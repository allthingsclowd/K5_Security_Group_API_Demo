...
def delete_security_group_rule(k5token, ruleId):
    """Summary
    ...
    Returns:
        TYPE: Description
    """
    networkURL = unicode(get_endpoint(k5token, "networking")) + unicode('/v2.0/security-group-rules/') + unicode(ruleId)
    print networkURL
    token = k5token.headers['X-Subject-Token']
...
def create_security_group_rule(k5token, security_group_id, direction, portmin, portmax, protocol, cidr):
    """Summary
